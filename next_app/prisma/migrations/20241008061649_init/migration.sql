/*
  ...
  - The `id` column on the `Absence` table would be dropped and recreated. This will lead to data loss if there is data in the column.
...
-- CreateIndex
CREATE INDEX "AttendanceRecord_attendanceId_idx" ON "AttendanceRecord"("attendanceId");
